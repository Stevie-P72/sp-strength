    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personal_info_first_name', models.CharField(blank=True, max_length=80, null=True)),
                ('personal_info_last_name', models.CharField(blank=True, max_length=80, null=True)),
